...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --save_path ./paper_checkpoint/paper_xpo_main_nokl_es_overlong \
   --ckpt_path ./paper_checkpoint/paper_xpo_main_nokl_es_overlong_ckpt \
   --save_hf_ckpt \
   ...
   --wandb_run_name paper_xpo_main_nokl_es_overlong \
   --overlong_penalty_factor 0.1 \
   --overlong_buffer_len 300 
