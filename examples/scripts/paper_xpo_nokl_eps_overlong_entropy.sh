...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --save_path ./paper_checkpoint/paper_xpo_main_nokl_eps_overlong_entropy \
   --ckpt_path ./paper_checkpoint/paper_xpo_main_nokl_eps_overlong_entropy_ckpt \
   --save_hf_ckpt \
   ...
   --wandb_run_name paper_xpo_main_nokl_eps_overlong_entropy \
