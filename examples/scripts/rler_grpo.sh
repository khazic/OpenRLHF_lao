...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --pretrain /xfr_ceph_sh/liuchonghan/OpenRLHFM/examples/scripts/checkpoint/qwen2_5_sft_domain \
   --reward_pretrain /xfr_ceph_sh/liuchonghan/OpenRLHFM/examples/scripts/checkpoint/rm-1 \
   --save_path ./checkpoint/qwen2_5_rler_grpo_2 \
   ...
   --prompt_data /xfr_ceph_sh/liuchonghan/OpenRLHFM/grpo_dataset \
