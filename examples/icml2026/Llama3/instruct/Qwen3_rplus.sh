...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --pretrain /xfr_ceph_sh/liuchonghan/Llama3-8b \
   --reward_pretrain /xfr_ceph_sh/liuchonghan/Skywork-Reward-V2-Qwen3-8B \
   --save_path ./paper_checkpoint/ICML2026_Llama3_rplus \
   --ckpt_path ./paper_checkpoint/ICML2026_Llama3_rplus_ckpt \
   --save_hf_ckpt \
   ...
   --prompt_data /xfr_ceph_sh/liuchonghan/prompt_dataset/instruct_cleaned.jsonl \
   ...
   --wandb_run_name ICML2026_Instruct_Llama3_rplus